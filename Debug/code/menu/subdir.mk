...
clean-code-2f-menu:
	-$(RM) ./code/menu/menu.d ./code/menu/menu.o ./code/menu/menu.src ./code/menu/menu_gps.d ./code/menu/menu_gps.o ./code/menu/menu_gps.src ./code/menu/menu_icm.d ./code/menu/menu_icm.o ./code/menu/menu_icm.src ./code/menu/menu_params.d ./code/menu/menu_params.o ./code/menu/menu_params.src ./code/menu/menu_pid.d ./code/menu/menu_pid.o ./code/menu/menu_pid.src ./code/menu/wifi_menu.d ./code/menu/wifi_menu.o ./code/menu/wifi_menu.src
