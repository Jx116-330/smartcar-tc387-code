...
/* ==== Hardware (U60 right rear, GPIO-polled DIR+pulse) ====
 * TIM5 is taken by Turn (steering encoder on P10.3/P10.1), so the right rear
 * encoder stays on GPIO polling via CCU61_CH1 ISR at RREAR_POLL_US. */
#define RREAR_PULSE_PIN             P21_7
#define RREAR_DIR_PIN               P21_6

/* ==== Parameters, aligned with rear_left ==== */
...
#define RREAR_SIGN                  +1         /* vehicle test: forward motion already gives positive count */
...
/* ==== Data interface, field names align with rear_left_get_* ==== */
