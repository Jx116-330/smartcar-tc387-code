...
#define IPS200_SCL_PIN_SPI              (SPI3_SCLK_P02_7 )                      // 硬件 SPI SCK 引脚
#define IPS200_SDA_PIN_SPI              (SPI3_MOSI_P02_6 )                      // 硬件 SPI MOSI 引脚
#define IPS200_SDA_IN_PIN_SPI           (SPI3_MISO_P02_5 )                      // 硬件 SPI MISO 引脚  IPS没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
//====================================================硬件 SPI 驱动====================================================
#endif
// 如果使用的是SPI 串口的两寸屏幕 SPI 驱动控制引脚 可以修改
#define IPS200_RST_PIN_SPI              (P02_8)                                 // (SPI串口)液晶复位引脚定义
#define IPS200_DC_PIN_SPI               (P02_5)                                 // (SPI串口)液晶命令位引脚定义
#define IPS200_CS_PIN_SPI               (P02_4)                                 // (SPI串口)液晶片选引脚定义
